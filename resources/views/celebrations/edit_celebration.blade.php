...
@section('title') Edit celebration @endsection

@section('dashboard_title') Edit celebrations @endsection
    ...
    <div class="accordion" id="accordionExample">
        <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                ...
                <form method="POST" action="{{ route('update_celebration', $celebration['id']) }}"> 
                    @csrf
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $celebration['title'] }}" required>
                        @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        name='publish_start' 
                        value="{{ $celebration['publish_start'] }}" required  onchange="TestDates();">
                    ...
                    <div class="form-group">
                        ...
                        name='publish_end' 
                        value="{{ $celebration['publish_end'] }}" required  onchange="TestDates();">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="body" name='body' rows="20">{{ $celebration['body'] }}</textarea>
                        @if ($errors->has('body'))
                            <span class="help-block">
                    ...
                    <div class="input-group">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="image_path" value="{{ $celebration['image_path'] }}" >
