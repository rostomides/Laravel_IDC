...
<div class="container">
  <hr>
  <h2>Update the date for prayer time change</h2>
    <form action="{{ route('update_iqamah', $iqamah['id']) }}" method='POST' class="form-inline">
        {{ csrf_field() }}
  
          <div class="form-group">
            <label for="date" class="form-control-label">Date</label>
            <input type="date" class="form-control ml-1" id="date"  name='date' required value="{{ $iqamah['date'] }}">
            @if ($errors->has('date'))
                <span class="help-block">
          ...
          <div class="form-group ml-2">
              ...
              <input type="time" class="form-control ml-1" id="fajr"  name='fajr' required value="{{ $iqamah['fajr'] }}">
              @if ($errors->has('fajr'))
                  <span class="help-block">
            ...
            <div class="form-group ml-2">
              ...
              <input type="time" class="form-control ml-1" id="duhr"  name='duhr' required value="{{ $iqamah['duhr'] }}">
              @if ($errors->has('duhr'))
                  <span class="help-block">
            ...
            <div class="form-group ml-2">
              ...
              <input type="time" class="form-control ml-1" id="asr"  name='asr' required value="{{ $iqamah['asr'] }}">
              @if ($errors->has('asr'))
                  <span class="help-block">
            ...
            <div class="form-group ml-2">
              ...
              <input type="time" class="form-control ml-1" id="maghrib"  name='maghrib' required value="{{ $iqamah['maghrib'] }}">
            ...
            <div class="form-group ml-2">
              ...
              <input type="time" class="form-control ml-1" id="isha"  name='isha' required value="{{ $iqamah['isha'] }}">
              @if ($errors->has('isha'))
                  <span class="help-block">
